...
import type { Session, Message, Adapter, PolicyConfig, WsEvent, AgentRef } from './types.js'
...
export class Router extends EventEmitter {
  ...
  private async callWithRetry(adapter: Adapter, session: Session, message: string): Promise<string> {
    let lastErr: unknown
